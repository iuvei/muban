<template>
  <div class="user-personal-updata">
    ...
    <input-inline label="真实姓名">
      <input v-model.number="Data.accountName" :readonly="userData.accountName?true:false" type="text">
    </input-inline>
    <input-inline label="手机号码">
      <input v-model.number="Data.phone" :readonly="userData.phone?true:false" type="text">
    </input-inline>
    <input-inline label="出生日期">
      <input v-model="Data.birthday" :readonly="userData.birthday?true:false" type="date">
    </input-inline>
