<template>
  <div class="page_content_wrap">
    <div class="ul_auto_wrap main_nav_with_arrow_Julien forgot-pwd-part">
      <ul class="cfx">
        <li class="active">
          <router-link :to="{path:'/forgotpwd/phone'}">
        ...
        <li>
        <router-link :to="{path:'/forgotpwd/email'}">
            <img src="./images/icon_mail02.png" >
