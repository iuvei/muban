    ...
    data() {
      return {
        ...
        rowdata: [
          ...
          {name: '代理提款', to: {name: "money_drawmoney"}},
          {name: '站内信', to: {name: "user_message"}},
          {name: '绑定银行卡/折号', to: {name: "addbank"}},
          // {name:'联系在线客服',to:{path:"http://www.baidu.com/"}},
        ],
        colData: [
          {name: "本月总输赢", view: 0, ico:"yg-tongqian"},
          {name: "本月总返水", view: 0, ico:"yg-qianbao"},
          {name: "本月总优惠", view: 0, ico:"yg-youhuiquan1"},
          {name: "会员总人数", view: 0, ico:"yg-renshu"},
          {name: "本月注册量", view: 0, ico:"yg-zhuceliangtongji"},
          {name: "本月投注额", view: 0, ico:"yg-4"}
        ]
      }
    },
    created() {
