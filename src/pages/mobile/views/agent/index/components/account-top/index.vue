<template>
  <div class="agent-account-top">
      <div class="account-img">
        ...
        <router-link class="personal" :to="{name:'user_personal'}">个人资料&nbsp;&nbsp;></router-link>
      </div>
      <div class="account-name">{{userData.loginname}},你好！</div>
      <div class="agent-account-info-money">
        <span class="agent-account-info-money-text">{{userData.slotAccount + userData.liveAccount}}</span><br>
        <span class="agent-account-info-money-text1">总佣金（元）</span>
      </div>
