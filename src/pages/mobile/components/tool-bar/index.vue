      ...
      <transition name="slideLeft">
        <div v-show="myValue" class="tool-bar">
          ...
          <div class="tool-user-info" v-else>
            ...
            <div class="account-info">
              <router-link @click.native="myValue=false" :to="{name:'login'}" class="btn">登陆</router-link>
              <router-link @click.native="myValue=false" :to="{path:'/register'}" class="btn rig-btn">注册</router-link>
            </div>
          </div>
          ...
          <div @click="myValue=false" class="sidebar">
            ...
            <router-link class="tool-item-href" :to="{name:'user_security'}" v-if="islogin">
              <i class="iconyg yg-068zhanghuanquan"></i>账户安全
              <i class="iconyg yg-jiantou fr"></i>
            </router-link>
            <router-link class="tool-item-href" :to="{name:'user_message'}" v-if="islogin">
            ...
            <router-link class="tool-item-href" :to="{name:'user_personal'}" v-if="islogin">
