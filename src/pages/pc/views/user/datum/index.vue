  ...
  <div class="form-rowbox perfect-data">
    <el-form :model="Data" ref="infoForm" label-width="100px" class="info-form">
      <el-form-item label="真实姓名" prop="accountName">
        <el-input v-model.number="Data.accountName" :readonly="userData.accountName?true:false" placeholder="输入真实姓名，必须与银行卡姓名一致"></el-input>
      </el-form-item>

      <el-form-item label="手机号码" prop="phone">
        <el-input v-model.number="Data.phone" :readonly="userData.phone?true:false" placeholder="输入手机号码">
          <el-button slot="append" icon="el-icon-error" v-if="userData.phoneValidStatus==0" @click="checkverify" style="color:#ed7e12!important">未验证</el-button>
          <el-button slot="append" icon="el-icon-success" v-else>已验证</el-button>
        </el-input>
      </el-form-item>
      ...
      <el-form-item label="银行卡" prop="bankno" v-if="isCompleting">
