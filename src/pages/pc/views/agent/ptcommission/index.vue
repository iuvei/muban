      ...
      <div class="user-discount">
        <div class="discount-content form-rowbox ptcommission">
          ...
          <el-table :data="pageContents" style="width: 100%" v-loading="loading">
            ...
            <el-table-column property="id"  label="平台"></el-table-column>
            <el-table-column property="amount"  label="日佣金"></el-table-column>
            <el-table-column property="id"  label="数据日期"></el-table-column>
            <el-table-column property="profitall"  label="输赢额度"></el-table-column>
            <el-table-column property="couponfee"  label="优惠额度"></el-table-column>
            <el-table-column property="ximafee"  label="洗码额度"></el-table-column>
            <el-table-column property="platformfee"  label="平台费"></el-table-column>
            <el-table-column property="betall"  label="投注额"></el-table-column>
            <el-table-column property="tempExcuteTime"  label="执行时间"></el-table-column>
          </el-table>
          <!-- 表格分页 -->
