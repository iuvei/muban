<template>
  <el-form :model="pwdForm" status-icon :rules="pwdrules" ref="pwdForm" label-width="100px" class="password-ruleForm">
    ...
    <el-form-item label="旧密码" prop="password">
      <el-input :type="passwordType.password" v-model="pwdForm.password" placeholder="请输入旧的登陆密码">
    ...
    <el-form-item label="新密码" prop="new_password">
      <el-input :type="passwordType.new_password" v-model="pwdForm.new_password" auto-complete="off" placeholder="请输入新的登陆密码">
    ...
    <el-form-item label="确认密码" prop="confirm_password">
      <el-input :type="passwordType.confirm_password" v-model="pwdForm.confirm_password" auto-complete="off" placeholder="请再次输入新的登陆密码">
